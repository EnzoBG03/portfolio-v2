        ...
        <div className="hero-about-visual">
          <div className="hero-about-image">
            <div style={{"width":"90%","height":"90%","borderRadius":"50%","background":"var(--bg-dark)","display":"flex","alignItems":"center","justifyContent":"center","fontSize":"3rem","position":"relative","zIndex":"2"}}>
              <img src="./Images/moi2.png" style={{"width":"100%","height":"100%","borderRadius":"50%","objectFit":"cover"}} />
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="personality-section">
      <div className="section-container">
        ...
        <div className="cards-grid">
          ...
          <div className="hobbies-card" data-type="Musique" data-description="Mon approche éclectique de la musique nourrit ma créativité et ma capacité d'adaptation. Cette diversité culturelle est une véritable source d'inspiration dans mes projets.">
            <div className="card-icon">
              <div style={{"fontSize":"2rem","position":"relative","zIndex":"3"}}>🎵</div>
            </div>
            <div className="card-content">
          ...
          <div className="hobbies-card" data-type="Cinéma" data-description="Mon attrait pour la science-fiction et le fantastique est un véritable moteur pour ma capacité à innover : cela me permet de stimuler ma réflexion sur les technologies émergentes et leurs applications futures.">
            <div className="card-icon">
              <div style={{"fontSize":"2rem","position":"relative","zIndex":"3"}}>🍿</div>
            </div>
            <div className="card-content">
