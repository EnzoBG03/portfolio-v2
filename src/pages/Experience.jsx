        ...
        <div className="hero-experience-visual">
          <div className="hero-experience-image">
            <div style={{"width":"90%","height":"90%","borderRadius":"50%","background":"var(--bg-dark)","display":"flex","alignItems":"center","justifyContent":"center","fontSize":"3rem","position":"relative","zIndex":"2"}}>
              <img src="./Images/moi5.png" style={{"width":"100%","height":"100%","borderRadius":"50%","objectFit":"cover"}} />
            </div>
          </div>
        </div>
      </div>
        ...
        <ul className="timeline">
          <li className="experience">
            ...
            <div className="content">
              ...
              <div className="buttons">
                <a href="https://www.nexus-france.fr/" target="_blank" className="experience-button">En savoir plus sur l'entreprise</a>
              </div>
            </div>
          </li>
          ...
          <li className="experience">
            ...
            <div className="content">
              ...
              <div className="buttons">
                <a href="https://yansys-medical.fr/" target="_blank" className="experience-button">En savoir plus sur l'entreprise</a>
              </div>
            </div>
          </li>
          ...
          <li className="experience">
            ...
            <div className="content">
              ...
              <div className="buttons">
                <a href="https://www.fleurus.fr/" target="_blank" className="experience-button">En savoir plus sur l'entreprise</a>
              </div>
            </div>
          </li>
        </ul>
